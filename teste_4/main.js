...
Para pessoa não esteja isenta, avalia-se seus rendimentos tributáveis ao longo do ano. Na condição em que o total de rendimentos seja superior a R$ 28.559,70,
a pessoa deve pagar imposto de renda, caso contrário, não.
...
let totalDeRendimentosDigitados = 2859969;
if (aposentado || doencaGrave) {
  resultado = "isento";
} else if (totalDeRendimentos <= totalDeRendimentosDigitados) {
  resultado = "vaza leao ta difcil sem vc";
} else {
  resultado = "pega leao";
}
